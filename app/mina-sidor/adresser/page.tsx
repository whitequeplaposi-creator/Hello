        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900">{t('myPagesAddressesPageTitle')}</h1>
            </div>
            <p className="text-gray-500">{t('myPagesAddressesPageSubtitle')}</p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          {addresses.length === 0 && !showForm ? (
            <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">{t('addressesEmptyTitle')}</h2>
              <p className="text-gray-500 mb-6">{t('addressesEmptyBody')}</p>
              <button
                type="button"
            ...
            <div className="space-y-6">
              {addresses.length > 0 && (
                <div className="flex justify-between items-center">
                  <h2 className="text-xl font-semibold text-gray-900">{t('addressesYourTitle')}</h2>
                  {!showForm && (
                    <button
                      type="button"
                      onClick={() => setShowForm(true)}
              ...
              {showForm && (
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">{t('addressesFormTitle')}</h3>
                  </div>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder={t('addressesPlaceholderFullName')}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                        placeholder={t('addressesPlaceholderStreet')}
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                          placeholder={t('addressesPlaceholderCity')}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                        placeholder={t('addressesPlaceholderPhone')}
                      />
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label className="ml-2 text-sm text-gray-700">{t('addressesDefaultCheckbox')}</label>
                    </div>
