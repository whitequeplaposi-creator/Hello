      ...
      <main className="flex-1 flex items-center justify-center px-4 py-4">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5">
            ...
            <button type="submit" disabled={isLoading} className="w-full px-3 py-1.5 text-sm bg-sky-400 text-white font-medium rounded-md hover:bg-sky-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mt-1">
              {isLoading ? (
                <>
          ...
          <p className="text-center text-gray-500 text-xs mt-3">{t('termsText')}</p>
        </div>
      </main>
    </div>
  )
