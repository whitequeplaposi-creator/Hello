  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2.5 w-full px-3 py-2 border border-gray-300 rounded-md bg-white hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-colors text-sm font-medium text-gray-700 shadow-sm"
      >
